            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper my-16" >
                {
                    review.map(item => <SwiperSlide
                        className="space-y-8 px-16 text-center"
                    ...
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none" className="mx-auto">
                        ...
                        <div>
                            ...
                            <h1 className="text-3xl font-bold mt-4 text-orange-400 uppercase">{item.name}</h1>
                        </div>
